  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-zinc-300 bg-white/70 px-6 py-12 text-center">
          ...
          {searches.map((search) => (
            ...
            >
              ...
              <div className="flex shrink-0 items-center gap-2">
                <Link
                  href={`/talent/mapper?searchId=${search.id}`}
                  className="rounded-full border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 transition hover:border-emerald-400 hover:text-emerald-700"
                >
                  Open
                </Link>
                <button
