...
const inputClass =
  "w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 shadow-sm placeholder-zinc-400 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100";
...
export default function ProfileTab({ profile, onSave }: Props) {
  ...
  return (
    <div className="space-y-8">
      {/* Import from resume */}
      <section className="rounded-2xl border border-brand-200 bg-brand-50/50 p-6 shadow-sm">
        <h2 className="text-sm font-semibold text-zinc-800">Import from resume</h2>
        ...
        >
          ...
          {file ? (
            ...
            <>
              <p className="text-sm text-zinc-600">Drag & drop your PDF resume</p>
              <p className="mt-1 text-xs text-zinc-400">or</p>
              <button
                type="button"
                onClick={() => fileInputRef.current?.click()}
                className="mt-2 rounded-full border border-zinc-200 bg-white px-4 py-1.5 text-xs font-medium text-zinc-700 shadow-sm hover:bg-zinc-50"
              >
                Choose PDF
              </button>
            </>
        ...
        {importNotice && (
          <p className="mt-3 text-sm text-emerald-700">{importNotice}</p>
        )}
        ...
        <button
          ...
          className="mt-4 w-full rounded-full bg-brand-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700 disabled:opacity-50"
        >
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold text-zinc-700">Personal Info</h2>
      ...
      {/* Target */}
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold text-zinc-700">Job Target</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      {/* Experience */}
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold text-zinc-700">Experience</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      {/* Skills */}
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold text-zinc-700">Skills</h2>
      ...
      {/* Work Auth */}
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold text-zinc-700">Work Authorization</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Field label="Country">
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
        <h2 className="mb-1 text-sm font-semibold text-zinc-700">Cover Letter Template</h2>
      ...
      <button
        onClick={handleSave}
        className="w-full rounded-full bg-brand-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700"
      >
